...
const skillGroups = [
  {
    ...
    skills: ['Java', 'JavaScript', 'C++', 'C', 'Python', 'SQL', 'HTML5', 'CSS3'],
  },
  {
    category: 'Frontend',
    icon: (
    ...
    skills: ['React.js', 'TypeScript', 'JSP', 'Tailwind CSS', 'Responsive Design', 'Django'],
  },
  {
    category: 'Backend',
    icon: (
  ...
  },
  {
    ...
    skills: ['DSA', 'DBMS & Normalization', 'Problem Solving', 'OOP', 'Computer Networks'],
  },
  {
    ...
    skills: ['Git', 'GitHub', 'VS Code', 'Docker', 'Postman', 'NetBeans', 'Vercel'],
  },
]
